...
{
    public partial class addCircleTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropPrimaryKey(name: "PK_Admin_Permission", schema: "dbo", table: "Admin_Permission");
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FilePath = table.Column<string>(type: "varchar", nullable: true),
                    FileSize = table.Column<long>(nullable: false),
                    FileType = table.Column<string>(type: "varchar", nullable: true),
                    Filename = table.Column<string>(type: "varchar", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Disabled = table.Column<bool>(nullable: false),
                    ForumName = table.Column<string>(type: "nvarchar", nullable: true),
                    Hot = table.Column<int>(nullable: false),
                    IsDelete = table.Column<bool>(nullable: false),
                    Logo = table.Column<string>(type: "varchar", nullable: true),
                    Moderators = table.Column<string>(type: "nvarchar", nullable: true),
                    OrderNo = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReplyUsername = table.Column<string>(type: "nvarchar", nullable: true),
                    TopicID = table.Column<long>(nullable: false),
            ...
            migrationBuilder.AddPrimaryKey(
                name: "PK_Admin_Permission",
                schema: "dbo",
                table: "Admin_Permission",
                columns: new[] { "AdminID", "ModuleID" });
        }

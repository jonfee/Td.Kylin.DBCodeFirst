...
namespace Td.Kylin.DBApi.Data
{
    public class InitProvider
    {
        ...
        /// API与模块授权数据
        /// </summary>
        public static List<System_ModuleAuthorize> ApiModuleAuthorizeList
        {
            get
            {
        ...
        public static int InitApiMoudleAuthoriza()
        {
            using (var db = new DataContext())
            {
                ...
                if (null != list && list.Count > 0) db.System_ModuleAuthorize.RemoveRange(list);

                db.System_ModuleAuthorize.AddRange(ApiModuleAuthorizeList);

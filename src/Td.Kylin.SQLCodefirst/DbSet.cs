...
namespace Td.Kylin.SQLCodeFirst
{
    public partial class DataContext
    {
		...
		public DbSet<Luckydraw_AreaConfig> Luckydraw_AreaConfig
		{
			get
			{
				return Set<Luckydraw_AreaConfig>();
			}
		}
		public DbSet<Luckydraw_AreaTicketGivingRules> Luckydraw_AreaTicketGivingRules
		{
			get
			{
				return Set<Luckydraw_AreaTicketGivingRules>();
			}
		}

		public DbSet<Luckydraw_LotteryRecord> Luckydraw_LotteryRecord
		{
			get
			{
				return Set<Luckydraw_LotteryRecord>();
			}
		}
		public DbSet<Luckydraw_PlatformConfig> Luckydraw_PlatformConfig
		{
			get
			{
				return Set<Luckydraw_PlatformConfig>();
			}
		}

		public DbSet<Luckydraw_Prize> Luckydraw_Prize
		{
			get
			{
				return Set<Luckydraw_Prize>();
			}
		}

		public DbSet<Luckydraw_PrizePool> Luckydraw_PrizePool
		{
			get
			{
				return Set<Luckydraw_PrizePool>();
			}
		}

		public DbSet<Luckydraw_Ticket> Luckydraw_Ticket
		{
			get
			{
				return Set<Luckydraw_Ticket>();
			}
		}

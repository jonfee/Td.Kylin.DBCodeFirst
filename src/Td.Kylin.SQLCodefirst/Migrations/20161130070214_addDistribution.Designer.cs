...
namespace Td.Kylin.SQLCodefirst.Migrations
{
    ...
    [Migration("20161130070214_addDistribution")]
    partial class addDistribution
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Td.Kylin.Entity.Distribution_AreaConfig", b =>
                {
                    b.Property<int>("AreaId");

                    b.Property<int>("InstantExpectedDeliveryTime");

                    b.Property<int>("NormalExpectedDeliveryTime");

                    b.HasKey("AreaId");

                    b.ToTable("Distribution_AreaConfig");
                });

            modelBuilder.Entity("Td.Kylin.Entity.Distribution_ExpressCompany", b =>
                {
                    ...
                    b.ToTable("Distribution_ExpressCompany");
                });

            modelBuilder.Entity("Td.Kylin.Entity.Distribution_Member", b =>
                {
                    ...
                    b.ToTable("Distribution_Member");
                });

            modelBuilder.Entity("Td.Kylin.Entity.Distribution_MemberMessage", b =>
                {
                    ...
                    b.ToTable("Distribution_MemberMessage");
                });

            modelBuilder.Entity("Td.Kylin.Entity.Distribution_MemberOperationRecord", b =>
                {
                    ...
                    b.ToTable("Distribution_MemberOperationRecord");
                });

            modelBuilder.Entity("Td.Kylin.Entity.Distribution_MemberWarehouseRelation", b =>
                {
                    b.Property<long>("MemberId");
                    ...
                    b.HasKey("MemberId", "WarehouseId");

                    b.ToTable("Distribution_MemberWarehouseRelation");
                });

            modelBuilder.Entity("Td.Kylin.Entity.Distribution_Order", b =>
                {
                    ...
                    b.Property<long?>("ExpressCompanyId");

                    b.Property<string>("ExpressOrderCode")
                        .HasColumnType("varchar(50)");
                    ...
                    b.ToTable("Distribution_Order");
                });

            modelBuilder.Entity("Td.Kylin.Entity.Distribution_OrderDetail", b =>
                {
                    ...
                    b.ToTable("Distribution_OrderDetail");
                });

            modelBuilder.Entity("Td.Kylin.Entity.Distribution_OrderNotify", b =>
                {
                    ...
                    b.ToTable("Distribution_OrderNotify");
                });

            modelBuilder.Entity("Td.Kylin.Entity.Distribution_OrderRecord", b =>
                {
                    b.Property<long>("RecordId");
                    ...
                    b.Property<short>("OperationSection");
                    ...
                    b.ToTable("Distribution_OrderRecord");
                });

            modelBuilder.Entity("Td.Kylin.Entity.Distribution_OrderSchedule", b =>
                {
                    ...
                    b.Property<short>("AssignType");

                    b.Property<short?>("HandleAction");

                    b.Property<DateTime?>("HandleTime")
                        .HasColumnType("smalldatetime");

                    b.Property<long?>("Handler");
                    ...
                    b.ToTable("Distribution_OrderSchedule");
                });

            modelBuilder.Entity("Td.Kylin.Entity.Distribution_Warehouse", b =>
                {
                    b.Property<long>("WarehouseId");
                    ...
                    b.Property<DateTime>("OnWorkTime")
                        .HasColumnType("time");

                    b.Property<int>("ServiceRange");
                    ...
                    b.ToTable("Distribution_Warehouse");
                });
